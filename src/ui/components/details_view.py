...
Displays full question information, tags, rich body with code copy, 
collapsible comments, and sorted answers with accepted solution styling.
"""
...
class QuestionDetailsView(ctk.CTkScrollableFrame):
    ...
    - Question header, stats, author badge, external link button
    - Question tags
    - Question rich body
    - Question comments accordion drawer
    - Answers header & list of answers
    - Answer accepted solution banner, score, rich body, comments
    """
    ...
    def show_welcome_state(self):
        ...
        desc_lbl = ctk.CTkLabel(
            welcome_card,
            text="Enter a query in the search bar above to find questions & answers.\nClick any question on the left to view full solutions, code, and comments.",
    ...
    def load_question(self, question: Dict[str, Any], language: str):
        ...
        # Meta Row: Score, Views, Answers, Date, Author, Link
        ...
        rich_body = RichContentView(q_card, html_content=body_html, wraplength=660)
    ...
    def render_answer_card(self, parent, ans_data: Dict[str, Any], index: int):
        ...
        rich_body = RichContentView(card, html_content=body_html, wraplength=660)
    ...
    def render_comment_item(self, parent, comment_dict: Dict[str, Any]):
        """Render an individual comment pill."""
        ...
        txt_lbl.pack(fill="x", padx=10, pady=(6, 2))
    ...
    def refresh_view(self):
        """Re-render current question and answers to update accordions."""
